...
A diferencia de Descartar a carpeta, que deja intacta la fila de la base de datos hasta un nuevo escaneo, Eliminar borra la fila de la foto de inmediato — no hace falta `--cleanup-missing-photos` para que desaparezca de la galería.
