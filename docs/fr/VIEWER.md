...
Contrairement à Trier vers un dossier, qui laisse la ligne de base de données intacte jusqu'à un nouveau scan, Supprimer efface immédiatement la ligne de la photo — aucun `--cleanup-missing-photos` n'est nécessaire pour qu'elle disparaisse de la galerie.
