...
A differenza di Scarta in cartella, che lascia intatta la riga del database fino a una nuova scansione, Elimina rimuove subito la riga della foto — non serve `--cleanup-missing-photos` perché sparisca dalla galleria.
